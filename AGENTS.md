...
- **[hallucination]** Never mention functions or classes that do not appear in the fetched files. Nonexistent names used: fetch_code_snippet. Confirm every symbol with fetch_code_snippet before documenting it. _(from failure: [run 8980866a-0354-48e0-a8fe-342fd80337fa] Draft for VictorZhayon/peom_ai_agent referenced names that exist in none of the fetched files: fetch_code_snippet)_
- **[hallucination]** Never mention functions or classes that do not appear in the fetched files. Nonexistent names used: JavaScript, fetch_code_snippet. Confirm every symbol with fetch_code_snippet before documenting it. _(from failure: [run dceda5d6-5173-4f8a-873a-94f1e93f1ed1] Draft for VictorZhayon/peom_ai_agent referenced names that exist in none of the fetched files: JavaScript, fetch_code_snippet)_
- **[hallucination]** Never mention functions or classes that do not appear in the fetched files. Nonexistent names used: Events. Confirm every symbol with fetch_code_snippet before documenting it. _(from failure: [run 7bafc949-5bd9-4770-96bd-8e9434639a45] Draft for VictorZhayon/peom_ai_agent referenced names that exist in none of the fetched files: Events)_
